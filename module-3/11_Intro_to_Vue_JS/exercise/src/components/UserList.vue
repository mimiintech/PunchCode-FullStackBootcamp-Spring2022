...
export default {
 ...
 computed: {
   ...
   if (this.filter.firstName != "") {
     filteredUsers = filteredUsers.filter(user => user.firstName.toLowerCase().includes(
       this.filter.firstName.toLowerCase()))
   }
 
   if (this.filter.lastName != "") {
     filteredUsers = filteredUsers.filter(user => user.lastName.toLowerCase().includes(
       this.filter.lastName.toLowerCase()))
   }
 
 if (this.filter.username != "") {
   filteredUsers = filteredUsers.filter(user => user.username.toLowerCase().includes(
     this.filter.username.toLowerCase()))
 }
 
if (this.filter.emailAddress != "") {
 filteredUsers = filteredUsers.filter(user => user.emailAddress.toLowerCase().includes(
