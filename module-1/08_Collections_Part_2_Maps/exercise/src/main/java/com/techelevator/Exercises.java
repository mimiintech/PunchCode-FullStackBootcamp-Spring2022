...
public class Exercises {
	...
	public String animalGroupName(String animalName) {
		...
		Map<String, String> listOfAnimals = new HashMap<String, String>();

		listOfAnimals.put("rhino", "Crash");
		listOfAnimals.put("giraffe", "Tower");
		listOfAnimals.put("elephant", "Herd");
		listOfAnimals.put("lion", "Pride");
		listOfAnimals.put("crow", "Murder");
		listOfAnimals.put("pigeon", "Kit");
		listOfAnimals.put("flamingo", "Pat");
		listOfAnimals.put("deer", "Herd");
		listOfAnimals.put("dog", "Pack");
		listOfAnimals.put("crocodile", "Float");

		String formattedAnimalName = animalName.toLowerCase();

		// if statement for element that do not exist in the map
		if (listOfAnimals.containsKey(formattedAnimalName)) {
			return listOfAnimals.get(formattedAnimalName);
	...
	public double isItOnSale(String itemNumber) {
		...
		result.put("KITCHEN6073", 0.40);
		result.put("BEDROOM3434", 0.60);
		result.put("BATH0073", 0.15);

		String formattedItemNumber = itemNumber.toUpperCase();
		if (result.containsKey(formattedItemNumber)) {
			return result.get(formattedItemNumber);
		}
		return 0.00;
	}
	...
	public Map<String, Integer> last2Revisited(String[] words) {
		...
		{int count = 0;
				...
				if (word.substring(i,i+2).equal(last2)) {
				count++;
		}
